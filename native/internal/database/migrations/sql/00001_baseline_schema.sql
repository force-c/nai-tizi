...
-- Name: biz_message_retry; Type: TABLE; Schema: public; Owner: -

CREATE TABLE public.biz_message_retry (
    id bigint NOT NULL,
    message_id character varying(100) NOT NULL,
    device_id bigint NOT NULL,
    device_mac character varying(50) NOT NULL,
    device_sn_num character varying(50),
    message_type integer NOT NULL,
    message_content text,
    max_retry_count integer DEFAULT 3,
    current_retry_count integer DEFAULT 0,
    status smallint DEFAULT 1,
    success_retry_sequence integer,
    success_time timestamp with time zone,
    abandon_reason character varying(200),
    create_time timestamp with time zone,
    update_time timestamp with time zone
);


-- Name: biz_message_retry_log; Type: TABLE; Schema: public; Owner: -

CREATE TABLE public.biz_message_retry_log (
...
-- Name: biz_message_retry_log biz_message_retry_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -

ALTER TABLE ONLY public.biz_message_retry_log
    ADD CONSTRAINT biz_message_retry_log_pkey PRIMARY KEY (log_id);


-- Name: biz_message_retry biz_message_retry_pkey; Type: CONSTRAINT; Schema: public; Owner: -

ALTER TABLE ONLY public.biz_message_retry
    ADD CONSTRAINT biz_message_retry_pkey PRIMARY KEY (id);
...
-- Name: idx_biz_message_retry_device_id; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_biz_message_retry_device_id ON public.biz_message_retry USING btree (device_id);


-- Name: idx_biz_message_retry_log_message_id; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_biz_message_retry_log_message_id ON public.biz_message_retry_log USING btree (message_id);


-- Name: idx_biz_message_retry_log_retry_id; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_biz_message_retry_log_retry_id ON public.biz_message_retry_log USING btree (retry_id);


-- Name: idx_biz_message_retry_message_id; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_biz_message_retry_message_id ON public.biz_message_retry USING btree (message_id);
...
DROP TABLE IF EXISTS public.biz_message_retry_log CASCADE;
DROP TABLE IF EXISTS public.biz_message_retry CASCADE;
