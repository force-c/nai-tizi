...
func (h *FileController) UploadFile(c *echo.Context) {
...
func (h *FileController) DownloadFile(c *echo.Context) {
    ctx := context.Background()
    s3 := h.ctr.GetS3()
...
func (h *FileController) GetPresignedURL(c *echo.Context) {
    ctx := context.Background()
    s3 := h.ctr.GetS3()
    ...
    response.Success(c, map[string]any{"url": url})
}

// DeleteFile 删除文件
// DELETE /NTZ/file/:key
func (h *FileController) DeleteFile(c *echo.Context) {
    ctx := context.Background()
    s3 := h.ctr.GetS3()
...
// ListFiles 列出文件
// GET /NTZ/file/list
func (h *FileController) ListFiles(c *echo.Context) {
    ctx := context.Background()
    s3 := h.ctr.GetS3()
...
import (
    ...
    "github.com/gcc798/quick.admin/internal/s3manager"
)
