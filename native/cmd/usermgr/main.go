...
//
// 密码只能通过 QUICK_ADMIN_USERMGR_PASSWORD 环境变量传入，不接受命令行参数，
...
const passwordEnv = "QUICK_ADMIN_USERMGR_PASSWORD"
...
func main() {
	...
	cfg, _, err := config.Load(opts.configDir)
	if err != nil {
...
func parseOptions(args []string) (options, error) {
	...
	set.StringVar(&opts.configDir, "config-dir", "cmd/api", "配置文件目录")
